...
# pose_resnet related params
POSE_RESNEXT = CN()
POSE_RESNEXT.NUM_LAYERS = 50
POSE_RESNEXT.DECONV_WITH_BIAS = False
POSE_RESNEXT.NUM_DECONV_LAYERS = 3
POSE_RESNEXT.NUM_DECONV_FILTERS = [256, 256, 256]
POSE_RESNEXT.NUM_DECONV_KERNELS = [4, 4, 4]
POSE_RESNEXT.FINAL_CONV_KERNEL = 1
POSE_RESNEXT.BASE_WIDTH = 4
POSE_RESNEXT.CARDINALITY = 32
POSE_RESNEXT.STEM_KERNEL_SIZE = 7
POSE_RESNEXT.PRETRAINED_LAYERS = ['*']
...
# POSE_HIGH_RESOLUTION_NET.STAGE1 = CN()
# POSE_HIGH_RESOLUTION_NET.STAGE1.NUM_MODULES = 1
# POSE_HIGH_RESOLUTION_NET.STAGE1.NUM_BRANCHES = 1
# POSE_HIGH_RESOLUTION_NET.STAGE1.NUM_BLOCKS = [4]
# POSE_HIGH_RESOLUTION_NET.STAGE1.NUM_CHANNELS = [64]
# POSE_HIGH_RESOLUTION_NET.STAGE1.BLOCK = 'BOTTLENECK'
# POSE_HIGH_RESOLUTION_NET.STAGE1.FUSE_METHOD = 'CAT'
...
MODEL_EXTRAS = {
    ...
    'pose_resnetstem3x3': POSE_RESNET,
    'pose_resNeXt': POSE_RESNEXT,
